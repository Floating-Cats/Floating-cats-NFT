...
- If you haven't, run `npm install` to install dependencies.
...
- If you haven't, run `npx hardhat compile`. This runs the solidity compiler to convert your code (`./contracts`) into binary.
- If you haven't, run `npx hardhat run scripts/MyScript.js --network localhost` to deploy our contract.
